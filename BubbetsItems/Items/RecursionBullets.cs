...
namespace BubbetsItems.Items
{
	public class RecursionBullets : ItemBase
	{
		...
		protected override void MakeTokens()
		{
			...
			AddToken("RECURSIONBULLETS_DESC_SIMPLE", "Attacking bosses increases " + "attack speed ".Style(StyleEnum.Damage) + "by " + "5% ".Style(StyleEnum.Damage) + "(+10% per stack, caps at ".Style(StyleEnum.Stack) + "10% attack speed".Style(StyleEnum.Damage) + ")".Style(StyleEnum.Stack) + ". " + "Corrupts all Armor-Piercing Rounds".Style(StyleEnum.Void));
