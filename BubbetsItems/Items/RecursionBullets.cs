...
namespace BubbetsItems.Items
{
	public class RecursionBullets : ItemBase
	{
		...
		protected override void MakeTokens()
		{
			...
			AddToken("RECURSIONBULLETS_DESC_SIMPLE", "Attacking bosses increases " + "attack speed ".Style(StyleEnum.Damage) + "by " + "5% ".Style(StyleEnum.Damage) + ", capping at " + "10% ".Style(StyleEnum.Damage) + "(+10% per stack) ".Style(StyleEnum.Stack) + "attack speed".Style(StyleEnum.Damage) + ". " + "Corrupts all Armor-Piercing Rounds".Style(StyleEnum.Void));
