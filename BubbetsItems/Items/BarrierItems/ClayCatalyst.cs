...
namespace BubbetsItems.Items.BarrierItems
{
	public class ClayCatalyst : ItemBase
	{
		...
		protected override void MakeTokens()
		{
			...
			AddToken("CLAYCATALYST_DESC", "Release a " + "13m ".Style(StyleEnum.Heal) + "(+13% per stack) ".Style(StyleEnum.Gray) + "barrier effect ".Style(StyleEnum.Heal) + "during the Teleporter event, " + "multiplying barrier decay ".Style(StyleEnum.Heal) + "on all nearby allies for " + "80%".Style(StyleEnum.Heal) + ".");
