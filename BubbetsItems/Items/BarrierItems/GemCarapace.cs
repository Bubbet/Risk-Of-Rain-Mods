...
namespace BubbetsItems.Items.BarrierItems
{
	public class GemCarapace : ItemBase
	{
		...
		protected override void MakeTokens()
		{
			...
			AddToken("GEMCARAPACE_DESC", "1 " + "(+0.75 per stack)".Style(StyleEnum.Gray) + "seconds after getting hurt, gain a " + "18% temporary barrier".Style(StyleEnum.Heal) + ". Triggers up to 1 times.");
