...
namespace BubbetsItems.Items.BarrierItems
{
	public class BoneVisor : ItemBase
	{
		...
		protected override void MakeTokens()
		{
			...
			AddToken("BONEVISOR_DESC_SIMPLE", "Killing an enemy " + "decreases barrier decay ".Style(StyleEnum.Heal) + "by " + "95% ".Style(StyleEnum.Heal) + "(-5% per stack)".Style(StyleEnum.Stack) + ", lasting for " + "3 ".Style(StyleEnum.Utility) + "(+2 per stack) ".Style(StyleEnum.Stack) + "seconds.");
