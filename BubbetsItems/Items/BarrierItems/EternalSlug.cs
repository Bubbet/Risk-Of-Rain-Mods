...
namespace BubbetsItems.Items.BarrierItems
{
	public class EternalSlug : ItemBase
	{
		protected override void MakeTokens()
		{
			...
			AddToken("ETERNALSLUG_DESC", "Stops " + "temporary barrier ".Style(StyleEnum.Heal) + "from decaying naturally past " + "36% ".Style(StyleEnum.Heal) + "(scales logarithmically, caps at 80%)".Style(StyleEnum.Gray) + ".");
