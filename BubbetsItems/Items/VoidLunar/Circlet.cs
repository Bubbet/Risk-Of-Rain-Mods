...
namespace BubbetsItems.Items.VoidLunar
{
	public class Circlet : ItemBase
	{
		protected override void MakeTokens()
		{
			...
			AddToken(name + "_DESC_SIMPLE", "Every " + "10".Style(StyleEnum.Utility) +"(-50% per stack)".Style(StyleEnum.Stack) + " of gold gained reduce 1 second from cooldowns. "+"Temporarily stops any gold from being gained for 5 ".Style(StyleEnum.Health) +"(+5 per stack)".Style(StyleEnum.Stack) +" seconds upon being hit. ".Style(StyleEnum.Health) + convert);
